...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/renan/Documentos/git/pp-desafio-backend/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/renan/Documentos/git/pp-desafio-backend/venv/bin/deactivate.nu'
